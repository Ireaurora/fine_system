...
public class Fine {
	...
	public static void main(String[] args) {
		...
		double final_fine = 0;
		if (speed < speeding_limit) {
			System.out.println("Your travelling at a legal speed");
		}
		if (speed > speeding_limit  && speed < 90) {
			...
			System.out.println("Your travelling at an illegal speed, this is "
					+ "your fine:" +  "£" + final_fine);
